...
Multiservo::Error Multiservo::writeMicroseconds(uint8_t pin,
                                                uint16_t pulseWidth,
                                                uint8_t twiAddress,
...
Multiservo::Error Multiservo::writeMicroseconds(int pulseWidth) {
    ...
    return writeMicroseconds(m_iPin, m_pulseWidth, m_twiAddress,
                             nAttemptsDefault);
}
...
bool Multiservo::attached() const { return m_iPin != PinInvalid; }
